...
//    客服專線: 06-2596159
//    傳真電話: 06-2803781
//    本程式僅供學習使用，未經本公司允許，不得用於其他用途。 版權所有，仿冒必究！
//*******************************************************************************
...
#define MotorB_I3    11  //定義 I3 接腳
#define MotorB_I4    10  //定義 I4 接腳
...
void setup()
{
  ...
  myservo.attach(Servo_Pin,0,1000);
  
  analogWrite(MotorA_PWMA,R_Speed);    //設定馬達 (右) 轉速
  analogWrite(MotorB_PWMB,L_Speed);    //設定馬達 (左) 轉速
}
